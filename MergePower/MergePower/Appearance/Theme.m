...
@implementation DefaultTheme : NSObject
...
@interface MyVibrantTheme : NSObject <Theme>
@end

@implementation MyVibrantTheme
...
@interface MyJoyfulTheme : NSObject <Theme>
@end

@implementation MyJoyfulTheme
...
+ (Class)themeClassForType:(NSInteger)type
{
    switch (type) {
        case 1:
            return [MyVibrantTheme class];
        case 2:
            return [MyJoyfulTheme class];
        default:
